...
class NgxMatTimepickerAdapter {
    ...
    static formatTime(time, opts) {
        ...
        if (isTwelve) {
            return parsedTime.toLocaleString(Object.assign(Object.assign({}, DateTime.TIME_SIMPLE), { hour12: isTwelve })).replace(/\u200E/g, "");
        }
    ...
    static toLocaleTimeString(time, opts = {}) {
        ...
        }).toLocaleString(Object.assign(Object.assign({}, DateTime.TIME_SIMPLE), { hourCycle }));
    }
    /**
     *
     * @param time
...
class NgxMatTimepickerService {
    ...
    _setDefaultTime(time, format) {
        ...
        if (defaultDto.isValid) {
            ...
            this.minute = Object.assign(Object.assign({}, DEFAULT_MINUTE), { time: defaultDto.minute });
            this.period = period;
        }
        else {
            this._resetTime();
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.1", ngImport: i0, type: NgxMatTimepickerBaseDirective, decorators: [{
        ...
        return [{ type: NgxMatTimepickerService }, { type: NgxMatTimepickerEventService }, { type: NgxMatTimepickerLocaleService }, { type: undefined, decorators: [{
                        type: Inject,
    ...
    static disableMinutes(minutes, selectedHour, config) {
        if (config.min || config.max) {
            ...
            return minutes.map(value => {
                ...
                return Object.assign(Object.assign({}, value), { disabled: !NgxMatTimepickerAdapter.isTimeAvailable(currentTime.toFormat(NgxMatTimepickerFormat.TWELVE), config.min, config.max, "minutes") });
            });
        }
        return minutes;
    }
...
class NgxMatTimepickerToggleComponent {
    get disabled() {
        var _a;
        return this._disabled === void 0 ? (_a = this.timepicker) === null || _a === void 0 ? void 0 : _a.disabled : this._disabled;
    }
    set disabled(value) {
...
class NgxMatTimepickerFieldComponent {
    ...
    ngOnInit() {
        ...
        this.hour$ = this._timepickerService.selectedHour.pipe(tap((clockTime) => this._selectedHour = clockTime === null || clockTime === void 0 ? void 0 : clockTime.time), map(this._changeDefaultTimeValue.bind(this)), tap(() => this.isTimeRangeSet && this._updateAvailableMinutes()));
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.1", ngImport: i0, type: NgxMatTimepickerDirective, decorators: [{
        ...
        return [{ type: i0.ElementRef }, { type: NgxMatTimepickerLocaleService }, { type: i4.MatFormField, decorators: [{
                        type: Optional
                    }, {
                        type: Inject,
                        args: [MatFormField]
