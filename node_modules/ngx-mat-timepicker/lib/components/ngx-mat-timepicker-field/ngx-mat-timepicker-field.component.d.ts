...
export declare class NgxMatTimepickerFieldComponent implements OnInit, OnDestroy, ControlValueAccessor {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NgxMatTimepickerFieldComponent, "ngx-mat-timepicker-field", never, { "color": "color"; "defaultTime": "defaultTime"; "floatLabel": "floatLabel"; "format": "format"; "max": "max"; "min": "min"; "cancelBtnTmpl": "cancelBtnTmpl"; "confirmBtnTmpl": "confirmBtnTmpl"; "controlOnly": "controlOnly"; "disabled": "disabled"; "toggleIcon": "toggleIcon"; }, { "timeChanged": "timeChanged"; }, never, never, false, never>;
}
