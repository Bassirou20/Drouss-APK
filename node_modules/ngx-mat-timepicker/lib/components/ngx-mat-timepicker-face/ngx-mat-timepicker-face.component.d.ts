...
export declare class NgxMatTimepickerFaceComponent implements AfterViewInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NgxMatTimepickerFaceComponent, "ngx-mat-timepicker-face", never, { "color": "color"; "faceTime": "faceTime"; "format": "format"; "minutesGap": "minutesGap"; "selectedTime": "selectedTime"; "unit": "unit"; }, { "timeChange": "timeChange"; "timeSelected": "timeSelected"; }, never, ["*", "*"], false, never>;
}
