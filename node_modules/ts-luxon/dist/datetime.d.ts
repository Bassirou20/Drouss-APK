...
import { ToISOTimeOptions, ToISOFormat, ToSQLOptions, ToRelativeOptions, ToRelativeCalendarOptions, SetZoneOptions, GregorianDateTime, WeekDateTime, OrdinalDateTime, GenericDateTime, GenericDateTimePlurals, DateTimeOptions } from "./types/datetime";
...
export declare class DateTime {
     ...
     * @type {Object}
     */
    static readonly DATE_MED_WITH_WEEKDAY: {
        year: "numeric";
        month: "short";
        day: "numeric";
        weekday: "short";
     ...
     * @type {Object}
     */
    static readonly TIME_WITH_SECONDS: {
        hour: "numeric";
        minute: "numeric";
        second: "numeric";
    };
     ...
     * @type {Object}
     */
    static readonly TIME_WITH_SHORT_OFFSET: {
        hour: "numeric";
        minute: "numeric";
        second: "numeric";
        timeZoneName: "short";
     ...
     * @type {Object}
     */
    static readonly TIME_WITH_LONG_OFFSET: {
        hour: "numeric";
        minute: "numeric";
        second: "numeric";
        timeZoneName: "long";
     ...
     * @type {Object}
     */
    static readonly DATETIME_SHORT: {
        year: "numeric";
        month: "numeric";
        day: "numeric";
        hour: "numeric";
     ...
     * @type {Object}
     */
    static readonly DATETIME_SHORT_WITH_SECONDS: {
        year: "numeric";
        month: "numeric";
        day: "numeric";
        hour: "numeric";
     ...
     * @type {Object}
     */
    static readonly DATETIME_MED_WITH_SECONDS: {
        year: "numeric";
        month: "short";
        day: "numeric";
        hour: "numeric";
     ...
     * @type {Object}
     */
    static readonly DATETIME_MED_WITH_WEEKDAY: {
        year: "numeric";
        month: "short";
        day: "numeric";
        weekday: "short";
     ...
     * @type {Object}
     */
    static readonly DATETIME_FULL_WITH_SECONDS: {
        year: "numeric";
        month: "long";
        day: "numeric";
        hour: "numeric";
     ...
     * @type {Object}
     */
    static readonly DATETIME_HUGE_WITH_SECONDS: {
        year: "numeric";
        month: "long";
        day: "numeric";
        weekday: "long";
     ...
     * @type {string}
     */
    get numberingSystem(): Readonly<import("./types/locale").NumberingSystem>;
    /**
     ...
     * @return {Object}
     */
    static fromFormatExplain(text: string, fmt: string, options?: DateTimeOptions): import("./types/datetime").ExplainedFormat;
    /**
     * @deprecated use fromFormatExplain instead
     */
    static fromStringExplain(text: string, fmt: string, options?: DateTimeOptions): import("./types/datetime").ExplainedFormat;
    /**
     ...
     * @return {number}
     */
    get(unit: string): string | number | boolean | void | Locale | Readonly<Zone> | ((zone: ZoneLike, { keepLocalTime, keepCalendarTime }?: SetZoneOptions) => DateTime) | ((duration: number | DurationLike) => DateTime) | (() => Date) | (({ format, suppressSeconds, suppressMilliseconds, includeOffset, extendedZone }?: ToISOTimeOptions) => string) | (() => number) | ((duration: number | DurationLike) => DateTime) | (() => number) | ((unit: keyof DurationObject) => DateTime) | ((values: Partial<GregorianDateTime & WeekDateTime & OrdinalDateTime & DateTimeOptions> | Partial<import("./types/datetime").GregorianDateTimePlurals & import("./types/datetime").WeekDateTimePlurals & import("./types/datetime").OrdinalDateTimePlurals & DateTimeOptions>) => DateTime) | ((otherDateTime: DateTime, unit?: keyof DurationObject | (keyof DurationObject)[], opts?: DurationOptions) => Duration) | ((otherDateTime: DateTime, unit: keyof DurationObject) => boolean) | ((other: DateTime) => boolean) | ((options?: {
        format?: ToISOFormat;
    }) => string) | (({ suppressMilliseconds, suppressSeconds, includeOffset, includePrefix, extendedZone, format }?: ToISOTimeOptions) => string) | ((fmt: string, opts?: DateTimeOptions) => string) | ((offset?: number, opts?: SetZoneOptions) => DateTime) | (() => string) | ((formatOpts?: Intl.DateTimeFormatOptions & LocaleOptions, opts?: DateTimeOptions) => string) | (() => string) | ((unit: string) => string | number | boolean | void | Locale | Readonly<Zone> | ((zone: ZoneLike, { keepLocalTime, keepCalendarTime }?: SetZoneOptions) => DateTime) | ((duration: number | DurationLike) => DateTime) | (() => Date) | (({ format, suppressSeconds, suppressMilliseconds, includeOffset, extendedZone }?: ToISOTimeOptions) => string) | (() => number) | ((duration: number | DurationLike) => DateTime) | (() => number) | ((unit: keyof DurationObject) => DateTime) | ((values: Partial<GregorianDateTime & WeekDateTime & OrdinalDateTime & DateTimeOptions> | Partial<import("./types/datetime").GregorianDateTimePlurals & import("./types/datetime").WeekDateTimePlurals & import("./types/datetime").OrdinalDateTimePlurals & DateTimeOptions>) => DateTime) | ((otherDateTime: DateTime, unit?: keyof DurationObject | (keyof DurationObject)[], opts?: DurationOptions) => Duration) | ((otherDateTime: DateTime, unit: keyof DurationObject) => boolean) | ((other: DateTime) => boolean) | ((options?: {
        format?: ToISOFormat;
    }) => string) | (({ suppressMilliseconds, suppressSeconds, includeOffset, includePrefix, extendedZone, format }?: ToISOTimeOptions) => string) | ((fmt: string, opts?: DateTimeOptions) => string) | ((offset?: number, opts?: SetZoneOptions) => DateTime) | (() => string) | ((formatOpts?: Intl.DateTimeFormatOptions & LocaleOptions, opts?: DateTimeOptions) => string) | (() => string) | any | ((options: LocaleOptions) => DateTime) | ((opts?: {
        includeConfig: boolean;
    }) => GregorianDateTime & Partial<LocaleOptions>) | (() => DateTime[]) | ((opts?: {}) => {
        locale: string;
        numberingSystem: string;
        outputCalendar: string;
    }) | (() => DateTime) | ((locale: string) => DateTime) | ((unit: keyof DurationObject) => DateTime) | ((opts?: Intl.DateTimeFormatOptions & LocaleOptions) => Intl.DateTimeFormatPart[]) | (() => string) | (() => string) | (() => string) | (() => string) | (({ includeOffset, includeZone, includeOffsetSpace }?: ToSQLOptions) => string) | ((opts?: ToSQLOptions) => string) | (() => number) | (() => number) | (() => Date) | ((unit?: keyof DurationObject | (keyof DurationObject)[], opts?: DurationOptions) => Duration) | ((other: DateTime) => Interval) | ((options?: ToRelativeOptions) => string) | ((options?: ToRelativeCalendarOptions) => string)) | ((options: LocaleOptions) => DateTime) | ((opts?: {
        includeConfig: boolean;
    }) => GregorianDateTime & Partial<LocaleOptions>) | (() => DateTime[]) | ((opts?: {}) => {
        locale: string;
        numberingSystem: string;
     ...
     * @return {string}
     */
    toISO({ format, suppressSeconds, suppressMilliseconds, includeOffset, extendedZone }?: ToISOTimeOptions): string | null;
    /**
